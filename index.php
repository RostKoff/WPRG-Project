		...
		<div class="row">
			<div id="sidebar" class="sidebar-body position-relative px-0 pb-5 col-3 vh-100">
				<div class="overflow-y-auto h-100">
					...
					<button onclick="location.href = 'login-form.php'" class="action-button py-2 w-75 top-50 start-50 translate-middle position-absolute">Log-in</button>
...
<!--							</a>-->
<!--							<svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">-->
<!--								<image height="25" width="25" xlink:href="https://ui-avatars.com/api/?&name=Name+Surname&background=random&length=2&rounded=true&format=svg"></image>-->
<!--							</svg>-->
<!--							<span class="sidebar-text">Name Surname</span>-->
<!--						</div>-->
<!--						<div class="log-out-cover w-auto my-auto sidebar-hide">-->
<!--							<button type="button" class="w-100 px-2 py-1 h-100 log-out">-->
<!--								<svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">-->
