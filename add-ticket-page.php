            ...
            <div class="container">
                ...
                <div class="row pt-3">
                    <div class="col-8">
                        ...
                        <input id="title" name="title" class="w-100" type="text" maxlength="255" required>
                        <label for="description">Description</label> <br>
                        <textarea class="w-100" name="description" id="description" cols="30" rows="10" maxlength="1000" required></textarea>
